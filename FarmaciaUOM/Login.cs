    ...
    public partial class Login : Form
    {
        ...
        public string Init(string Usuario, string Clave)
        {
            ...
            if (aTable.Rows.Count > 0)
            {
                ...
                UsuarioValidado.UsuarioId = aTable[0].id;
        ...
        public static void capturarUsuario(TextBox Usuario)
        {
            ...
            {
                MessageBox.Show("Error de contraseña o usuario", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
